...
public class VFlight_Booking extends javax.swing.JFrame {
    ...
    private void btnBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookingActionPerformed
        try {
            ...
            boolean seatsAvailable = fli_book.checkSeatAvailability(flightNumber, flightClass, passengers);
            if (!seatsAvailable) 
            {
                throw new Exception(flightClass + " for flight " + flightNumber + " is fully booked or cannot accommodate the requested " + passengers + " passengers.");
            }
